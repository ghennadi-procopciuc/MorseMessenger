 ...
 * @author Ghennadi
 */
public class MainWindow_j extends JFrame {
	public MainWindow_j() {
		initComponents();
	}
	...
	private void initComponents() {
		...
		((GridBagLayout)contentPane.getLayout()).rowWeights = new double[] {1.0, 0.0, 1.0, 1.0E-4};
		...
		contentPane.add(morseLabel, new GridBagConstraints(1, 0, 1, 1, 0.0, 0.0,
		...
		//======== panel2 ========
		{
			...
			((GridBagLayout)panel2.getLayout()).rowHeights = new int[] {0, 24, 0, 0};
			...
			//======== panel4 ========
			{
				...
				((GridBagLayout)panel4.getLayout()).columnWidths = new int[] {0, 16, 100, 0};
				...
				panel4.add(userLabel, new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0,
					GridBagConstraints.CENTER, GridBagConstraints.BOTH,
					new Insets(0, 0, 5, 5), 0, 0));
				panel4.add(usernameField, new GridBagConstraints(2, 0, 1, 1, 0.0, 0.0,
					GridBagConstraints.CENTER, GridBagConstraints.BOTH,
					new Insets(0, 0, 5, 0), 0, 0));

				//---- passwordLabel ----
				passwordLabel.setText("Password :");
				panel4.add(passwordLabel, new GridBagConstraints(0, 1, 1, 1, 0.0, 0.0,
					GridBagConstraints.CENTER, GridBagConstraints.BOTH,
					new Insets(0, 0, 0, 5), 0, 0));
				panel4.add(passwordField, new GridBagConstraints(2, 1, 1, 1, 0.0, 0.0,
					GridBagConstraints.CENTER, GridBagConstraints.BOTH,
			...
			//---- wrongPasswordLabel ----
			wrongPasswordLabel.setText("<html><font color=\"red\">Username or password is incorrect !</font></html>");
			wrongPasswordLabel.setHorizontalAlignment(SwingConstants.CENTER);
			panel2.add(wrongPasswordLabel, new GridBagConstraints(0, 1, 1, 1, 0.0, 0.0,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH,
				new Insets(0, 0, 5, 0), 0, 0));
			...
			//======== panel3 ========
			{
				...
				panel3.add(signInButton, new GridBagConstraints(1, 0, 1, 1, 0.0, 0.0,
					GridBagConstraints.CENTER, GridBagConstraints.BOTH,
					new Insets(0, 0, 0, 5), 0, 0));
			}
