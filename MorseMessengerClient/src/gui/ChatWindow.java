...
public class ChatWindow extends JFrame implements ActionListener {
	...
	private void initComponents() {
		...
		// ======== panel1 ========
		{
			...
			// ======== panel4 ========
			{
				...
				// ---- friendAvatarLabel ----
				friendAvatarLabel.setIcon(new ImageIcon(Resources.MORSE_ICON));
				friendAvatarLabel
				...
				// ---- userAvatarLabel ----
				userAvatarLabel.setIcon(new ImageIcon(Resources.MORSE_ICON));
	...
	public void addMessage(String username, Boolean localUser, String message) {
		...
		chatText += "<bold><span style=\"color:" + (localUser ? "blue" : "red")
				+ ";font-weight:bold\">" + username + " : &nbsp </span></bold>";
	...
	public void sendMessageAction() {
		...
		if (communicationMode == Resources.ASCII_MODE) {
			addMessage("Ghennadi Procopciuc", true, message);
			messageTextArea.setText("");
		} else {
	...
	public static void main(String[] args) {
		...
		ch.addMessage("Ghennadi Procopciuc", true,
